...
class UserRegistrationForm(UserCreationForm):
	...
	password1 = forms.CharField(widget=forms.PasswordInput(attrs={"required":False, "render_value":False, "placeholder":"Password", "class":"form-control"}), label=(""))
	password2 = forms.CharField(widget=forms.PasswordInput(attrs={"required":False, "render_value":False, "placeholder":"Confirm Password", "class":"form-control"}), label=(""))
...
class EditUserForm(forms.ModelForm):
	...
	email = forms.EmailField(help_text="Used for some notifications and to retrieve your profile from Gravatar. Never displayed publicly."
		,widget=forms.TextInput(attrs={"required":True, "placeholder":"Email Address", "class":"form-control"}), label=(""))
	first_name = forms.CharField(widget=forms.TextInput(attrs={"required":True,"placeholder":"First Name", "class":"form-control"}), label=(""))
	last_name = forms.CharField(widget=forms.TextInput(attrs={"required":True,"placeholder":"Last Name", "class":"form-control"}), label=(""))
...
class PasswordForm(forms.Form):
	...
	password0 = forms.CharField(widget=forms.PasswordInput(attrs={"required":False,"render_value":False, "placeholder":"Current Password", "class":"form-control"}), label=(""))
	password1 = forms.CharField(widget=forms.PasswordInput(attrs={"required":False,"render_value":False, "placeholder":"New Password", "class":"form-control"}), label=(""))
	password2 = forms.CharField(widget=forms.PasswordInput(attrs={"required":False,"render_value":False, "placeholder":"Confirm New Password", "class":"form-control"}), label=(""))
